"""Encryption and decryption utilities for .env file content."""
...
def encrypt(plaintext: str, password: str) -> str:
    """Encrypt plaintext with a password. Returns a base64-encoded ciphertext."""
...
def decrypt(encoded: str, password: str) -> str:
    """Decrypt a base64-encoded ciphertext with a password. Returns plaintext."""
